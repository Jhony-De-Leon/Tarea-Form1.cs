...
namespace miFormularioTarea.Clases
{
    class Crud
    {

        string connectionString = "Server=DESKTOP-MNQI1M5\\SQLEXPRESS;Database=CLASE10;Integrated Security=True; TrustServerCertificate=True; ";
